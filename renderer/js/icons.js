...
const P = {
  /* ── Identidad ─────────────────────────────────────────────────────────────
     La marca de Apex: una curva de concentración —sube rápido, baja largo—
     sobre su línea de base apagada, con el ápice marcado. Es lo que la app
     mide, y es el nombre, dicho en 16 px.
     Tiene que coincidir con el splash y el brand de index.html. */
  onyx: '<path d="M2.2 12.4C4.2 12.4 4.9 3.6 7 3.6S9.6 12.4 13.8 12.4"/>'
      + '<path class="ox-brand__trail" d="M2.2 12.4H13.8"/>'
      + '<circle cx="7" cy="3.6" r="1.5" fill="currentColor" stroke="none"/>',
